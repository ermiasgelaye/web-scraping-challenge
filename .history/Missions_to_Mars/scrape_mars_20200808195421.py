...
def scrape():
   ...
   # loop over results to get list
    for result in results:
        ...
        post = {'title': news_title, 'paragraph': news_p, 'date': date}
        return post
    ...
    browser.visit(url)
    time.sleep(3)
    mars_tweets = [soup.find_all('p', class_="TweetTextSize"), weather_soup.find_all('span', class_="css-901oao css-16my406 r-1qd0xha r-ad9z0x r-bcqeeo r-qvutc0")]
